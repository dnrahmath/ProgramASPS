...
public class koneksiData {
    ...
    static final int TotalArray = 1000;
    ...
    */
    ...
    {   
        ...
        int totalData = TotalArray; //Jumlah diCustom dari backend
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public static String[][] cSelectOneLogin(String nmTbl,String[] listColmn,int totalArray,String colDb,String colDbs,String colDbPass)  
        {   
            //-------------------------------------------------------------------------
            String sqlString = "SELECT * FROM "+nmTbl+" WHERE "+colDb+"='"+colDbs+"' AND password='"+colDbPass+"'";
    ...
    public static String[][] cSelectAll(String nmTbl,String[] listColmn,int valKeAwal,int jmlhTampil,int ArrayTotal)  
        {   
            //-------------------------------------------------------------------------
            String sqlString = "SELECT * FROM "+nmTbl;
            //ditambah option
            
            // Awal - Handle Error ----------------------------------------------------------------------------------
            try {
                String dataQuery[][]= mGetSqlEQ(sqlString,nmTbl,listColmn,valKeAwal,jmlhTampil,ArrayTotal,0);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public static String[][] cDeleteOne(String nmTbl,String colDb,String colDbTarget)  
        {   
            //-------------------------------------------------------------------------
            String sqlString = "DELETE FROM "+nmTbl+" WHERE "+colDb+"='"+colDbTarget+"'";
    ...
    public static String[][] cDeleteAll(String nmTbl)  
        {   
            //-------------------------------------------------------------------------
            String sqlString = "DELETE FROM "+nmTbl;
    ...
    public static String[][] cInsert(String nmTbl,String[] listColmn,String[] listColmnRow)  
        {   
            ...
            */
            ...
            String sqlString = "INSERT INTO "+DB_NAME+"."+nmTbl+" (`";
            ...
            for (int k = 0; k < kBatas; k++) {  //akan berhenti sebelum nilai kBatas
                sqlString += dataAll[0][k]+"`,`";
            }
            sqlString += dataAll[0][kBatas];
            
            //sqlString += "`) VALUES (NULL,'";  //karena sudah AUTO_INCREMENT sudah otomatis
            sqlString += "`) VALUES ('";  //karena sudah AUTO_INCREMENT sudah otomatis
            for (int k = 0; k < kBatas; k++) {
                sqlString += dataAll[1][k]+"','";
            }
            sqlString += dataAll[1][kBatas];
            sqlString += "')";
    ...
    public static String[][] cUpdate(String nmTbl,String[] listColmn,String[] listColmnRow,String colDb,String colDbTarget)  
        {   
            ...
            */
            ...
            //Awal - proses pembuatan string SQL sebelum di eksekusi ---------------------------
            String sqlString = "UPDATE "+DB_NAME+"."+nmTbl+" SET ";
            
            int kBatas = listColmn.length - 1;
            for (int k = 1; k < kBatas; k++) {
                sqlString += "`"+dataAll[0][k]+"` = '"+dataAll[1][k]+"', ";
            }
            sqlString += "`"+dataAll[0][kBatas]+"` = '"+dataAll[1][kBatas]+"' ";
            sqlString += "WHERE "+colDb+"="+colDbTarget;
            //System.out.println(sqlString);
            //Akhir - proses pembuatan string SQL sebelum di eksekusi ---------------------------
