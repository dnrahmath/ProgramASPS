 ...
 * @author dnrahmath
 */
public class GeMenuDataTamu extends javax.swing.JFrame {
    ...
    Color arrColor[] = {unSelectColor,unSelectColor,unSelectColor,unSelectColor,SelectColor,unSelectColor};
    
    public GeMenuDataTamu() {
        initComponents();
    ...
    public void setValue(){
        ...
        if("UPDATE".equals(ModeExec)){
            ...
            txtasal.setText(listColmnRow[2]);
            txtcttn.setText(listColmnRow[3]);
            txttgl.setText(listColmnRow[4]);
        }else{
            //.setText("");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/programasps/images/icon_asps/iloveimg-resized-32/group (2).png"))); // NOI18N
        ...
        txtcttn.setRows(5);
        txtcttn.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcttnKeyPressed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelIsi1Layout.createSequentialGroup()
                ...
                .addGroup(panelIsi1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panelIsi1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtasal, javax.swing.GroupLayout.PREFERRED_SIZE, 317, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panelBtn1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBtn1Layout.createSequentialGroup()
                .addGap(55, 55, 55)
                .addComponent(btnExec, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                .addGap(63, 63, 63)
                .addComponent(btnCancle, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                .addGap(57, 57, 57))
        );
    ...
    private void txtasalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtasalKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==evt.VK_ENTER){
            txtcttn.requestFocusInWindow();
        }
    }//GEN-LAST:event_txtasalKeyPressed

    private void txtcttnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcttnKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==evt.VK_ENTER){
            submitDataFunc();
        }
    }//GEN-LAST:event_txtcttnKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeMenuDataTamu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                GeMenuDataTamu fRegis = new GeMenuDataTamu();
