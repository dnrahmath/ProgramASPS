...
CREATE TABLE perpustakaan.tbl_buku (
  `id_buku` INT(255) COLLATE utf8mb4_unicode_ci NOT NULL AUTO_INCREMENT PRIMARY KEY, 
...
(NULL,"admin","admin@email.com","admin","201943500000","ADMIN","2010","LAKI-LAKI","088212789","","Jl.Gurame Bawal Teri"),
